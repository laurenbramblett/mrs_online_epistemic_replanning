function plot_plan_pretty_sims(robots_t,taskLoc,obsDist,makeVid,filename,fImg_robots,no_fImg_robots,alphachannel,no_alphachannel,time_start,initPose,colorDataStore)
...
rbt_size = max_dir*2/200;
txt_offset = max_dir*4/200;
flag_offset = rbt_size/1.0;
