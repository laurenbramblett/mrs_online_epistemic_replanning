function plot_plan_pretty(robots_t,taskLoc,obsDist,makeVid,filename,fImg_robots,no_fImg_robots,alphachannel,no_alphachannel,time_start,initPose,colorDataStore)
