function plot_plan_pretty_3botexample(robots_t,taskLoc,obsDist,makeVid,filename,fImg_robots,no_fImg_robots,alphachannel,no_alphachannel,time_start,initPose,colorDataStore)
        ...
        for r = 1:numBots
            for p = 1:numParticles
                ...
                plotPart(k,r,p) = scatter(pPlots(r,p).pose(1),pPlots(r,p).pose(2),...
                    60,cr(r,:),'MarkerEdgeColor','none','MarkerFaceColor',cr(r,:),'MarkerFaceAlpha',0.5);
                % end
            end
        end
    end
